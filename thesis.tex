...
What is the broad idea as a whole
...
Condensed Project Plan **OR** how the project was going to be achieved
Should include here some metrics about what we want the system to be able to do
\include{chapters/project_plan/project_plan}

How the development proceeded (**MIGHT BE GOOD TO TIE THIS TOGETHER WITH PROJECT PLAN**)
Good to find some references for different things we could habe done but didn't
Would be good to show that it has been thought about rather than just made up abritarily on the fly
...
\chapter{Discussion}
How does it compare to what was originally planned
